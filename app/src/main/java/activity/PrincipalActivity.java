...
import com.kiterio.teste.organizze.databinding.ActivityPrincipalBinding;
...
public class PrincipalActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_pincipal,menu);
    ...
    public void configuraCalendarView(){
        CharSequence meses[] = {"Janeiro","Fevereiro","Março","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro",
                                "Novembro","Dezembro"};
